...
function Decorations() {
	...
	return (
		<div
			...
			className="h-6 select-none w-screen game-font fixed z-1000 top-0 bg-sidebar border-b left-0 right-0 flex items-center"
		>
			<div className="w-full h-full flex items-center pointer-events-none	">
					...
					<AnimatePresence mode="wait" initial={false}>
						{online || true ? (
							<motion.div
								...
								className="h-full w-full gap-1 text-xs flex items-center justify-center"
							>
								<img src="IMMDecor.png" className="h-full min-w-fit p-2 -mr-2" />
							</motion.div>
						) : (
							<motion.div
								key="status-offline"
				...
				<div
					...
					className="flex items-center duration-200 justify-start"
				>
					<Button
						onClick={(e) => {
							e.stopPropagation();
