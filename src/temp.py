...
FILE_URLS = [
    "https://example.com/files/archive1.zip",
    "https://example.com/files/data.rar",
    "https://example.com/files/settings.7z",
...
def main():
    ...
    for url in FILE_URLS:
        ...
        try:
            ...
            # 2. Extract
            if not extract_file(download_path, specific_extract_dir):
...
if __name__ == "__main__":
    ...
    # --- SETUP (Run these commands in your Linux terminal first) ---
    #
